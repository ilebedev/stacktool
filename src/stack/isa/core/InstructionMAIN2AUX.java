...
public class InstructionMAIN2AUX extends Instruction {
	
	public InstructionMAIN2AUX(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.MAIN2AUX, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.MAIN2AUX);
	}
