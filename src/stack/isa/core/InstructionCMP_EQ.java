...
public class InstructionCMP_EQ extends Instruction {
	
	public InstructionCMP_EQ(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_EQ, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_EQ);
	}
