...
public class InstructionBXOR extends Instruction {
	
	public InstructionBXOR(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.BXOR, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.BXOR);
	}
