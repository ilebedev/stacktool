...
public class InstructionBZ extends OneImmediateInstruction {
	
	public InstructionBZ(int imm16, String comment){
		super(imm16, comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.BZ, getImmediate(), getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.BZ, getImmediate());
	}
