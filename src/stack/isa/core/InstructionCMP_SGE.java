...
public class InstructionCMP_SGE extends Instruction {
	
	public InstructionCMP_SGE(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_SGE, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_SGE);
	}
