...
public class InstructionCMP_UGE extends Instruction {
	
	public InstructionCMP_UGE(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_UGE, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_UGE);
	}
