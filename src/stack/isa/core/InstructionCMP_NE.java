...
public class InstructionCMP_NE extends Instruction {
	
	public InstructionCMP_NE(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_NE, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_NE);
	}
