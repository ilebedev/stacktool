...
public class InstructionCMP_ULE extends Instruction {
	
	public InstructionCMP_ULE(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_ULE, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_ULE);
	}
