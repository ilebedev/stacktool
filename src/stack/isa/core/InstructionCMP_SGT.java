...
public class InstructionCMP_SGT extends Instruction {
	
	public InstructionCMP_SGT(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_SGT, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_SGT);
	}
