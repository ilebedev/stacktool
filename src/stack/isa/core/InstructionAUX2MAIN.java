...
public class InstructionAUX2MAIN extends Instruction {
	
	public InstructionAUX2MAIN(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.AUX2MAIN, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.AUX2MAIN);
	}
