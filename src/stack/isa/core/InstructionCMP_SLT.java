...
public class InstructionCMP_SLT extends Instruction {
	
	public InstructionCMP_SLT(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_SLT, getComment());
	}
	
	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_SLT);
	}
