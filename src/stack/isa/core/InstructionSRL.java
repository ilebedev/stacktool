...
public class InstructionSRL extends OneImmediateInstruction {
	...
	public String toString() {
		return get_string(StackOP.SRL, getImmediate(), getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.SRL, getImmediate());
	}
