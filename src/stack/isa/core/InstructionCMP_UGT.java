...
public class InstructionCMP_UGT extends Instruction {
	
	public InstructionCMP_UGT(String comment){
		super(comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.CMP_UGT, getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.CMP_UGT);
	}
