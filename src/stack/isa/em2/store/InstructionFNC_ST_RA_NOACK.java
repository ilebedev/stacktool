...
public class InstructionFNC_ST_RA_NOACK extends RAInstruction implements StoreInstruction{
	
	public InstructionFNC_ST_RA_NOACK(int offset, String comment){
		super(offset, comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.FNC_ST_RA_NOACK, getImmediate(), getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.FNC_ST_RA_NOACK, getImmediate());
	}
