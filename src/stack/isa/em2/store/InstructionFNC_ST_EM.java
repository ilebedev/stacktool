...
public class InstructionFNC_ST_EM extends EMInstruction implements StoreInstruction{
	
	public InstructionFNC_ST_EM(int stack0, int stack1, int offset, String comment){
		super(stack0, stack1, offset, comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.FNC_ST_EM, imm8_hi, imm8_lo, getOffset(), getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.FNC_ST_EM, imm8_hi, imm8_lo, getOffset());
	}
