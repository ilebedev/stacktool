...
public class InstructionST_EM_NOACK extends EMInstruction implements StoreInstruction{
	
	public InstructionST_EM_NOACK(int stack0, int stack1, int offset, String comment){
		super(stack0, stack1, offset, comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.ST_EM_NOACK, imm8_hi, imm8_lo, getOffset(), getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.ST_EM_NOACK, imm8_hi, imm8_lo, getOffset());
	}
