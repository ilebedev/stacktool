...
public class InstructionFNC_LD_RA extends RAInstruction implements LoadInstruction{
	
	public InstructionFNC_LD_RA(int offset, String comment){
		super(offset, comment);
	}
	
	@Override
	public String toString() {
		return get_string(StackOP.FNC_LD_RA, getImmediate(), getComment());
	}

	@Override
	public int toBinary() {
		return assemble(StackOP.FNC_LD_RA, getImmediate());
	}
